...
#    Updated: 2019/05/06 14:53:56 by oargrave         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SOURCE = ft_printf.c print_arg.c buffer_output.c add_in_glbuffer.c bust.c print_date.c struct_specifier.c is_it_something.c read_flags.c print_diu.c ft_itoa_base.c print_char.c print_dl_dll.c parse.c print_int.c
OBJS = *.o
OBJDIR = .obj
NAME = libftprintf.a
